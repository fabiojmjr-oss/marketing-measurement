...
def main() -> None:
    ...
    print()
    print("   Read retargeting's row twice. The test ruled out returns above 1.41, and the design")
    print("   could not have established any return below 1.42. Those two numbers are always")
    print("   within one power quantile of each other - the ceiling is the estimate plus t times")
    print("   the standard error, the floor is t plus the power quantile times the same standard")
    print("   error - which is the general statement: a null holdout on a small channel buys an")
    print("   upper bound and cannot buy anything else.")
